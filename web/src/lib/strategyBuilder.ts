export const STRATEGY_SERIES_CATALOG = [
  ...
  { key: 'NO', label: 'Manufacturing New Orders', kind: 'raw', group: 'macro', description: 'FRED AMTMNO — monthly manufacturing new orders in USD.' },
  { key: 'ISM_PMI', label: 'ISM Manufacturing PMI', kind: 'raw', group: 'macro', description: 'ISM Manufacturing PMI diffusion index (50 = neutral).' },
